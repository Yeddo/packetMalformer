...
Description:
This script generates and sends malformed packets over specified network interfaces on Windows and Linux,
...
def get_active_interfaces_with_traffic():
    ...
    for iface in interfaces:
        if iface in net_io and net_io[iface].bytes_recv > 0 and net_io[iface].bytes_sent > 0:
